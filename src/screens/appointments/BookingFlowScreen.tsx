...
export default function BookingFlowScreen({ route, navigation }: any) {
    ...
    const { bookingLoading, bookingSuccess, bookingError } = useAppSelector((state) => state.appointments);
    const {
        patients,
    ...
    useEffect(() => {
        ...
        Alert.alert(
            ...
            [
                {
                    text: 'OK',
                    onPress: () => navigation.navigate(ROUTES.APPOINTMENT_HISTORY),
                },
            ],
            { cancelable: false },
        );
    }, [bookingSuccess, isRescheduleIntent, navigation]);
